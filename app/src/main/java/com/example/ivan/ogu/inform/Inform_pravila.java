 ...
 */
public class Inform_pravila extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Inform_pravila.myWebclient webViewClient = new Inform_pravila.myWebclient();
    ...
    public class NewThread extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg) {
            ...
            try {
                ...
                doc = Jsoup.connect("http://oreluniver.ru/pk/rules").get();
...
/*
    public class myWebclient extends WebViewClient {
        @Override
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://oreluniver.ru"));
                startActivity(intent);
                return true;
